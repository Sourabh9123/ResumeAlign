                        ...
                        <div className="w-full max-w-7xl mx-auto animate-fade-in pb-10">
                            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end mb-12 gap-6 border-b border-gray-800/80 pb-8">
                                ...
                                <div className="flex flex-wrap gap-4 items-center">
                                    ...
                                    {(results.pdf_s3_url || results.pdf_base64) && (
                                        <a 
                                            href={results.pdf_s3_url || `data:application/pdf;base64,${results.pdf_base64}`}
                                            download={results.pdf_s3_url ? undefined : `Optimized_Resume_${new Date().getTime()}.pdf`}
                                            target={results.pdf_s3_url ? "_blank" : undefined}
